...
import { listSubCategories } from "./subcategories";
import type { City, TalentCategory, TalentSubCategory } from "../types";
...
export async function listAllActiveSubCategories(): Promise<
  TalentSubCategory[]
> {
