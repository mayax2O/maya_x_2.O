  ...
  return (
    <html lang="en">
      <body className="flex min-h-screen flex-col">
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-50 focus:rounded-md focus:bg-porcelain focus:px-4 focus:py-2 focus:text-ink focus:shadow-md"
        >
          Skip to content
        </a>
        <ThemeProvider>
